...
class takingVC: UIViewController,UICollectionViewDelegate, UICollectionViewDataSource , UICollectionViewDelegateFlowLayout {
    ...
    @objc private func handleRefresh() {
        ...
        API_Gallary.banner(urls: "http://alhabib-abobakr.com/api_elshekh/MainApp/api_token=222&lang=en&section=taking"){ (error: Error?, gallry: [gallaryData]?) in
